...
<img src="images/create_virtual_machine_linux.png" alt="creating virtual machine" width=600/><br />

Using Tenable Nessus, Create Agent Group

<img src="images/create_agent_group_linux.png" alt="agent group" width=600/><br />

Create a **Basic Agent Scan** using the Nessus Agent scan template

<img src="images/create_scan_linux.png" alt="create scan" width=600/><br />

Add the agent group created earlier

<img src="images/add_agent_group_linux.png" alt="add agent group" width=600/><br />

Select triggered scan, set to file name, add name of desired file to trigger scan, and save. In this case, I use **start.txt**

<img src="images/select_triggered_scan_linux.png" alt="select triggered scan" width=600/><br />

Go back to **Agent Groups** and select **Add Nessus Agent** to copy the Linux command to install the agent
...
and edit as necessary before executing as root administrator to install the agent 


<img src="images/add_nessus_agent_linux.png" alt="add nessus agent" width=600/><br />

ssh into created Linux virtual machine and run command to install agent

<img src="images/ssh_linux.png" alt="remote desktop" width=600/><br />


<img src="images/install_agent_linux.png" alt="install agent" width=600/><br />

Wait for agent connection to link, then navigate to agent trigger file path and create file `start.txt`

<img src="images/agent_link_linux.png" alt="agent link" width=600/><br />

<img src="images/agent_trigger_file_path_linux.png" alt="trigger file path" width=600/><br /> 

<img src="images/create_file_linux.png" alt="" width=600/><br />
...
`incorporate scheduled scans for agent groups` 
